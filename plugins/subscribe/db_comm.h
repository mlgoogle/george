...
class DbSql {
 public:
  ...
  int cmp(const std::pair<std::pair<std::string, int>, int> &x,
   ...
   */
  /* -----------------------------------------------------------------------*/
  static bool QuerySection(int64 user_id,
