...
class VIPLimitData{
 public:
	...
	void set_surged_stock_num(const int64 surged_stock_num) {surged_stock_num_ =
			new base_logic::FundamentalValue(surged_stock_num);}
	void set_decline_stock_num(const int64 decline_stock_num) {decline_stock_num_ =
			new base_logic::FundamentalValue(decline_stock_num);}
	void set_time(const int64 current_time) {time_ =
			new base_logic::FundamentalValue(current_time);}
...
class STOIndustryData{
 public:
	...
	void set_change_percent(const double change_percent) {
		change_percent_ =
			new base_logic::FundamentalValue(change_percent);
	}
