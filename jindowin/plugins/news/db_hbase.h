...
#ifndef _HOME_TIANYIHENG_TEST_JINDOWIN_RUNNER_JINDOWIN_PLUGINS_NEWS_DB_HBASE_H_
#define _HOME_TIANYIHENG_TEST_JINDOWIN_RUNNER_JINDOWIN_PLUGINS_NEWS_DB_HBASE_H_
...
class DbHbase{
 ...
 public:
    static void InitHbase(std::string host, \
        int port, std::string table, int num = 2);
...
#endif  // _HOME_TIANYIHENG_TEST_JINDOWIN_RUNNER_JINDOWIN_PLUGINS_NEWS_DB_HBASE_H_
